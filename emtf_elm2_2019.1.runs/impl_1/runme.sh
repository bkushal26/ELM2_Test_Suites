...
HD_PWD='/home/ehep/Vivado_Projects/ELM_ALEX_project/emtf_elm2_2019.1/emtf_elm2_2019.1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cpu_block_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cpu_block_wrapper.tcl -notrace
