...
HD_PWD='/home/ehep/Vivado_Projects/ELM_ALEX_project/emtf_elm2_2019.1/emtf_elm2_2019.1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cpu_block_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cpu_block_wrapper.tcl
